...
Project <- "NPRatios48WellExperiment"
...
Treatment1Label = "Phosphorus umol PO4 L-1"
TreatmentVector1 <- c(0, 0.2, 0.5, 1, 2, 3, 5, 7)
...
Treatment2Label <-  "Nitrogen umol NO3 L-1"
TreatmentVector2 <- c(0, 5, 10, 30, 50, 70)
